<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="name" type="text" id="name" value="{{ isset($picture->name) ? $picture->name : ''}}" >
...
<div class="form-group {{ $errors->has('cover_image') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="cover_image" type="text" id="cover_image" value="{{ isset($picture->cover_image) ? $picture->cover_image : ''}}" >
